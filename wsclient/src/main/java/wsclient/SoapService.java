 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://wsserver/", wsdlLocation = "http://127.0.0.1:8080/soap?wsdl")
public class SoapService extends Service {

    private final static URL SOAPSERVICE_WSDL_LOCATION;
    private final static WebServiceException SOAPSERVICE_EXCEPTION;
    private final static QName SOAPSERVICE_QNAME = new QName("http://wsserver/", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/soap?wsdl");
    ...
    public Soap getSoapPort() {
        return super.getPort(new QName("http://wsserver/", "SoapPort"), Soap.class);
    }
    ...
    public Soap getSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsserver/", "SoapPort"), Soap.class, features);
    }
